...
import com.learn.index12306.framework.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * around 代表方法上有注解
     */
    @Around("@within(com.learn.index12306.framework.starter.log.annotation.ILog) || @annotation(com.learn.index12306.framework.starter.log.annotation.ILog)")
