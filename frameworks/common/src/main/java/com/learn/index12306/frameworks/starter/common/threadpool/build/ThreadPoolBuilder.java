package com.learn.index12306.frameworks.starter.common.threadpool.build;

import com.learn.index12306.frameworks.starter.designpattern.builder.Builder;
import com.learn.index12306.frameworks.starter.common.util.AssertUtil;
...
public final class ThreadPoolBuilder implements Builder<ThreadPoolExecutor> {
    ...
    private int calculateCoreNum() {
        ...
        return new BigDecimal(corePoolSize).divide(new BigDecimal("0.2")).intValue();
    }
